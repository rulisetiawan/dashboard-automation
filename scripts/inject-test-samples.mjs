...
const assets = [
  {
    ...
    values: { main_tank_temperature_pv: 92.6, main_tank_level_pv: 71.8, water_flow_pv: 124.5, dosing_tank_1_temperature_pv: 58.2, dosing_tank_2_temperature_pv: 42.7, tank_1_level_pv: 64.8, tank_2_level_pv: 37.2 },
    ...
    for (const [assetIndex, asset] of assets.entries()) {
      ...
      for (const [key, numericValue] of Object.entries(asset.values)) {
        ...
        for (let offset = 2; offset >= 0; offset--) {
          await pool.query("INSERT INTO telemetry_sample (asset_id,tag_code,source_ts,value_number,quality,gateway_id,message_id,ingested_at) VALUES ($1,$2,$3,$4,'GOOD','LOCAL-TEST',$5,$6)", [asset.id, tagCode, new Date(now.getTime() - offset * 60000).toISOString(), Number(numericValue) - offset * 0.02, randomUUID(), iso]);
        }
      }
