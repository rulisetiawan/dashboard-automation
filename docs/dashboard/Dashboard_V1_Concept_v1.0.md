...
Referensi: `Machine_Concept_Calator_v1.0.md`.
...
9. Dryer chamber ditampilkan sesuai jumlah aktual.
10. Kalender sensor dan motor hierarchy dapat ditelusuri.
11. Electrical supply path dapat ditelusuri sampai machine meter.
12. Water, steam, dan thermal oil context dapat ditampilkan sesuai instrumentasi.
13. Chemical request dan usage dapat dikaitkan ke Calator.
14. Historical chart dapat membandingkan actual, setpoint, state, dan alarm.
15. Operator, process, maintenance, utility, dan OT menyetujui validitas pilot.
16. Tidak ada write-back atau control command ke mesin.
...
## 31. Informasi yang Diperlukan untuk Dashboard v1.1
...
## 32. Keputusan Baseline Dashboard V1.0
