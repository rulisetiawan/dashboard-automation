...
| `machines/Machine_Concept_Kalender_v1.11.md` | 1.11 | Aktif | Motor log grouped yang rapi untuk R/S/T, load, drive, dan quality |
...
| `dashboard/Dashboard_V1_Concept_v1.19.md` | 1.19 | Aktif | Grouped Motor & Drive historical log table |
...
| `releases/Frontend_V1.40.md` | 1.40 | Selesai | Grouped Motor & Drive diagnostic table |
