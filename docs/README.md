...
| `dashboard/Dashboard_V1_Concept_v1.35.md` | 1.35 | Aktif | Pemulihan pie, ranking, output chart, alarm analysis, dan Historical Trend Explorer pada mode PostgreSQL aktual |
