...
| `dashboard/Dashboard_V2_Concept_v2.12.md` | 2.12 | Aktif | Utility Snapshot Plant Overview yang lebih jelas dan menyatu dengan tema utama |
...
| `backend/NestJS_PostgreSQL_Integration_v1.15.md` | 1.15 | Aktif | Change marker untuk auto-update chemical transaction insert/update/delete |
