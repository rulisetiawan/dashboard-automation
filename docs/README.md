...
| `chemicals/Chemical_Dispensing_Calator_Concept_v1.16.md` | 1.16 | Aktif | Feedback aktual posisi selector Auto/Manual pada unit dispensing |
| `dashboard/Dashboard_V2_Concept_v2.23.md` | 2.23 | Aktif | Status control mode aktual Chemical Dispensing pada overview dan detail unit |
