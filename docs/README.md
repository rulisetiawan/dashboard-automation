...
| `chemicals/Chemical_Dispensing_Calator_Concept_v1.17.md` | 1.17 | Aktif | Badge compact control mode pada header Live Process Schematic |
| `dashboard/Dashboard_V2_Concept_v2.24.md` | 2.24 | Aktif | Status Auto/Manual di sebelah status controller pada schematic Chemical Dispensing |
...
| `backend/NestJS_PostgreSQL_Integration_v1.19.md` | 1.19 | Aktif | Projection REST dan realtime feedback Auto/Manual Chemical Dispensing |
