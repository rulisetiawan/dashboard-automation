...
| `machines/Machine_Concept_Jetflow_v1.5.md` | 1.5 | Aktif | Trend batch Jetflow dengan process band dan marker perubahan SV recipe |
...
| `dashboard/Dashboard_V1_Concept_v1.6.md` | 1.6 | Aktif | Investigasi batch Jetflow dengan konteks recipe program pada trend PV/SV |
...
| `releases/Frontend_V1.27.md` | 1.27 | Selesai | Recipe program overlay pada trend batch Jetflow |
