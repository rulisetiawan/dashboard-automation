...
| `dashboard/Dashboard_V2_Concept_v2.29.md` | 2.29 | Aktif | Koreksi range Solar Fueling, log final, chart konsumsi, dan rekonsiliasi eksplisit |
| `solar/Solar_Fueling_System_Concept_v1.2.md` | 1.2 | Aktif | QR fueling aktual, histori penuh, chart konsumsi, dan rekonsiliasi liter/persen |
...
| `backend/Solar_Fueling_Backend_Integration_v1.2.md` | 1.2 | Aktif | Sinkronisasi perubahan status QR lama, histori lima tahun, dan validasi transaksi final |
