...
| `dashboard/Dashboard_V2_Concept_v2.13.md` | 2.13 | Aktif | Utility di KPI atas dan donut Production Output by Batch |
...
| `backend/NestJS_PostgreSQL_Integration_v1.16.md` | 1.16 | Aktif | API actual/effective/estimated production output per batch dan shift |
