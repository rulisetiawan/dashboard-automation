...
| `machines/Machine_Concept_Kalender_v1.8.md` | 1.8 | Aktif | Motor diagnostic R/S/T dengan min/avg/max dan troubleshooting finding |
...
| `dashboard/Dashboard_V1_Concept_v1.16.md` | 1.16 | Aktif | Historical troubleshooting Motor & Drive 3-phase |
...
| `releases/Frontend_V1.37.md` | 1.37 | Selesai | Historical Motor & Drive troubleshooting detail |
