...
| `dashboard/Dashboard_V1_Concept_v1.48.md` | 1.48 | Aktif | Peak card dinamis mengikuti parameter snapshot/tag aktual per mesin |
...
| `backend/NestJS_PostgreSQL_Integration_v1.9.md` | 1.9 | Aktif | API performance summary dengan pemilihan dynamic peak parameter |
