...
| `machines/Machine_Concept_Jetflow_v1.8.md` | 1.8 | Aktif | Batch context pada kartu mesin Jetflow per Lane |
...
| `dashboard/Dashboard_V1_Concept_v1.25.md` | 1.25 | Aktif | Batch context pada kartu fleet mesin |
