...
| `dashboard/Dashboard_V1_Concept_v1.31.md` | 1.31 | Aktif | Fleet, detail mesin, dan motor diagnostic membaca PostgreSQL langsung |
...
| `backend/NestJS_PostgreSQL_Integration_v1.5.md` | 1.5 | Aktif | Equipment motor 3-phase dan dashboard PostgreSQL actual-only |
